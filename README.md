![190601774-db1cbc4d-0daa-4853-a890-ebc6c15895ab](https://github.com/UjasPR/TATA-Virtual-Internship/assets/138766573/8dc1fd65-d79b-4e4e-a3c7-ec800cbc7d3e)

# TATA Data Visualisation Empowering Business with Effective Insights
[Live Dashboard Link](https://www.novypro.com/project/tata-retail-shop-analysis)

![Dashboard](https://github.com/UjasPR/TATA-Virtual-Internship/assets/138766573/72d7f279-5a3b-4e3f-a1e0-2c057a2ab62e)


The virtual experience programme is provided by Tata iQ or Tata Insights and Quants. I discover how passionate, multidisciplinary experts utilise data visualisation technology like Power BI to take on some of the most difficult business problems and uncover fascinating insights buried in the mountains of produced data. 
...
In this task, you will create visuals around four of the questions that the CEO and CMO have requested. You can use either Tableau or Power BI to create the visuals and we’ve provided the data in the resources below. 
Both Power BI and Tableau have free trials that can be accessed in order to complete this task. You can find a resource below that directs you on how to download these free trials.
